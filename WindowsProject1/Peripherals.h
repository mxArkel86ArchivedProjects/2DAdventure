...
class Peripherals
{
	...
	static bool controllerConnected(int i, XINPUT_STATE& state);
public:
	...
	static Point mouseClickLeftPos();
	static bool mouseClickedRight();
	static Point mouseClickRightPos();
	static PolarPoint controllerOutput(int i);
};
